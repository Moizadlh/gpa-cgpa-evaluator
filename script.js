...
function result_uploader(){
    ...
    document.getElementById("CGPA-2").innerHTML = "CGPA : " + (gpa)
    document.getElementById("percentage-2").innerHTML = "Percentage : " + percent +"%"
...
function result_cgpa(){
    ...
    document.getElementById("CGPA-3").innerHTML = "CGPA : " + (cgpa)
    document.getElementById("percentage-3").innerHTML = "Percentage : " + percent_c +"%"
